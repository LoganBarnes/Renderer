...
#include "CudaIntersections.cu"
#include "CudaRendererRandom.cu"
...
//        const float3 &n = surfel->normal;
            ...
            )
  {
    ...
    if ( intersectWorld( ray, shapes, numShapes, &surfel, -1, isEyeRay ) )
    {
      ...
      {
        L_o += *coeff * estimateDirectLightFromAreaLights(
                                                          &surfel,
                                                          shapes,
                                                          numShapes,
                                                          areaLights,
                 ...
                 )
  {
    ...
    tracePath_kernel << < block, thread >> > (
                                              surface,
                                              reinterpret_cast< float4* >( scaleViewInvEye ),
                                              shapes,
                                              numShapes,
                                              areaLights,
                                              numAreaLights,
